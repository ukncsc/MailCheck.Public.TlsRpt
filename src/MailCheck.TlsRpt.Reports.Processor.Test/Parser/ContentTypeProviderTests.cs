...
using ContentType = MailCheck.TlsRpt.Reports.Processor.Parser.ContentType;
...
namespace MailCheck.TlsRpt.Reports.Processor.Test.Parser
{
    ...
    public class ContentTypeProviderTests
    {
        ...
        public void SetUp()
        {
            _contentTypeProvider = new ContentTypeProvider(A.Fake<ILogger<ContentTypeProvider>>());
        }
