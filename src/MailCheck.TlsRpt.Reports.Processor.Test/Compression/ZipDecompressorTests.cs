...
namespace MailCheck.TlsRpt.Reports.Processor.Test.Compression
{
    ...
    public class ZipDecompressorTests
    {
        ...
        public void ZipCompressedStreamIsSucessfullyDecompressed()
        {
            ...
            byte[] decompressedStream = _zipDecompressor.Decompress(compressedStream);
            
            Assert.That(decompressedStream, Is.EqualTo("ZipDecompressorTest\n"));
        }

        [Test]
        public void ZipCompressedStreamWithMultipleFilesThrows()
        {
            Stream compressedStream = new MemoryStream(ZippedDataWithMultipleFiles);
