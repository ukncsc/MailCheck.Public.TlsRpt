...
namespace MailCheck.TlsRpt.Entity.Test.Entity.Notifiers
{
    ...
    public class AdvisoryChangedNotifierTests
    {
        ...
        //private TlsRptEntityState CreateEntityStateWithRecords(params Message[] messages)
        //{
        //    List<TlsRptRecord> records = messages.Select(x => new TlsRptRecord()).ToList();
        //    TlsRptEntityState entityState = new TlsRptEntityState("", 0, new TlsRptState(), DateTime.MaxValue)
        //    {
        //        TlsRptRecords = new TlsRptRecords("", records)
        //    };
